	...
	return r.db.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		...
		if err := tx.Create(&domain.App{
			...
			Settings: domain.AppSettings{
				...
				Keyword:     kb.Name,
				AutoSitemap: true,
				Icon:        domain.DefaultJCloudWikiIconB64,
				...
				Btns: []any{
					AppBtn{
						...
						Target:   "_blank",
						Text:     "鲸云智能",
						URL:      "https://www.jingyunos.com/gongsijieshao",
						Variant:  "outlined",
					},
				},
				FooterSettings: domain.FooterSettings{
					ICP:      "浙ICP备2023037385号",
					CorpName: "杭州鲸云智能科技制造有限公司",
				},
			},
		}).Error; err != nil {
			return err
